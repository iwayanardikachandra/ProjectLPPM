    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-3 col-md-3">
          <div class="logo">
             <a href="{{url('/')}}">
              <img src="{{asset('public/images/'.$Gsetting->logo)}}" alt="">
             </a>
          </div>
        </div><!-- logo col end -->
        @yield('add-header')
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-md-offset-1 col-sm-12 footer-widget">
            ...
            @foreach($gallery as $n)
              <a href="{{asset('public/images/'.$n->image)}}" class="gallery-popup cboxElement">
          ...
          <div class="col-md-12">
            <div class="footer-info-content">
              <div class="footer-logo">
                <img class="img-responsive" src="{{asset('public/images/'.$Gsetting->logo)}}" alt="" />
              </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.1/bootstrap3-typeahead.min.js"></script>
  ...
  <!-- Color box -->
  <script type="text/javascript" src="{{asset('public/assets/js/jquery.colorbox.js')}}"></script>
  <!-- Smoothscroll -->
