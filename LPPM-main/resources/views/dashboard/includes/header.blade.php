...
<link rel="icon" href="{{asset('public/images/'.$Gsetting->default_img)}}" type="image/x-icon" />
...
<link rel="stylesheet" href="{{asset('public/assets/admin/dist/css/bootstrap-tagsinput.css')}}">
<link rel="stylesheet" href="{{asset('public/assets/admin/css/bootstrap-toggle.min.css')}}">
  <link rel="stylesheet" href="{{asset('public/css/sweetalert.css')}}">
  <link rel="stylesheet" href="{{asset('public/assets/admin/dist/css/style.css')}}">
  ...
  <header class="main-header">
    ...
    <a  class="logo">
      <span class="logo-mini">
        <img src="{{asset('public/images/'.$Gsetting->default_img)}}" width="40px">
      </span>
      <span class="logo-lg">
        <img src="{{asset('public/images/'.$Gsetting->logo)}}" width="200px">
      </span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            @if(!Sentinel::getUser()->profile)
              <img src="{{asset('public/assets/admin/dist/img/pro.png')}}" class="user-image" alt="User Image">
              @else
            ...
            <ul class="dropdown-menu">
              ...
              @if(!Sentinel::getUser()->profile)
                <img src="{{asset('public/assets/admin/dist/img/pro.png')}}" class="img-circle" alt="User Image">
                @else
