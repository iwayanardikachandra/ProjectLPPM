...
<script src="{{asset('public/assets/admin/js/jquery.fileupload.js')}}"></script>
<!-- Bootstrap 3.3.6 -->
...
<!-- for my Custom js End-->

<!-- jQuery Knob Chart -->
<script src="{{asset('public/assets/admin/plugins/knob/jquery.knob.js')}}"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<!-- AdminLTE App -->
<script src="{{asset('public/assets/admin/plugins/daterangepicker/daterangepicker.js')}}"></script>
<!-- datepicker -->
<script src="{{asset('public/assets/admin/plugins/datepicker/bootstrap-datepicker.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="{{asset('public/assets/admin/css/jquery.littlelightbox.js')}}"></script>
