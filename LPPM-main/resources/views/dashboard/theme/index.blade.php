                ...
                <div class="col-md-6">
                  ...
                  {{csrf_field()}}
                    <input type="hidden" id="1" name="status"  value="1">
                      <div class="col-md-12">
                        <img style="max-height: 400px;;max-width: 100%;border:1px solid #ccc;" src="{{asset('public/images/theme1.PNG')}}">
                ...
                <div class="col-md-6">
                  ...
                  {{csrf_field()}}
                    <input type="hidden" id="2" name="status" value="2">
                      <div class="col-md-12">
                        <img style="max-height: 400px;max-width: 100%;border:1px solid #ccc;" src="{{asset('public/images/theme2.PNG')}}">
                        <div class="text-center">
                        <br>
                ...
                <div class="col-md-6">
                  ...
                  {{csrf_field()}}
                    <input type="hidden" id="3" name="status" value="3">
                      <div class="col-md-12">
                        <img style="max-width: 100%;border:1px solid #ccc; max-height: 400px;" src="{{asset('public/images/theme3.PNG')}}">
                        <div class="text-center">
                        <br>
                ...
                <div class="col-md-6">
                  ...
                  {{csrf_field()}}
                    <input type="hidden" id="4" name="status" value="4">
                      <div class="col-md-12">
                        <img style="max-width: 100%;border:1px solid #ccc; max-height: 400px;" src="{{asset('public/images/theme4.PNG')}}">
                        <div class="text-center">
                        <br>
