                        ...
                        <div role="tabpanel" class="tab-pane active" id="Logo">
                          ...
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              @else
                              <img src="{{asset('public/images/'.$Gsetting->logo)}}" height="70px" width="150px">
                              @endif
                            </div><br>
                          ...
                          <div class="box-body">
                              ...
                              {{csrf_field()}}
                                ...
                                <div class="form-group">
                                  ...
                                  @else
                                  <img src="{{asset('public/images/'.$Gsetting->default_img)}}" >
                                  @endif
                                </div><br>
...
<script src="{{asset('public/assets/admin/bootstrap/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
<script>
  $(function () {
    $(".textarea").wysihtml5();
  });
